<?php /*a:2:{s:64:"C:\Users\Administrator\web\tpflow\app\index\view\wf\wfindex.html";i:1581909452;s:62:"C:\Users\Administrator\web\tpflow\app\index\view\pub\base.html";i:1581909452;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<a onclick="layer_show('添加工作流','<?php echo url('wfadd'); ?>','550','400')" class="btn btn-primary radius">添加工作流</a>
</nav>
...
<table class="table table-border table-bordered table-bg">
    ...
    <tr>
        ...
        <td>
		<?php if($vo['edit'] ==""): ?>
	   <a class='btn  radius size-S' onclick="layer_show('修改','<?php echo url('wfedit',['id'=>$vo['id']]); ?>','550','400')"> 修改</a>
       <a class='btn  radius size-S' data-title="设计流程" data-href="<?php echo url('/index/wf/wfdesc',['flow_id'=>$vo['id']]); ?>" onclick="Hui_admin_tab(this)" > 设计流程</a>
		<?php else: ?>
		<a class='btn  radius size-S'> 运行中....</a>
	   <?php endif; if($vo['status'] == 0): ?>
		   <a class='btn  radius size-S' href="<?php echo url('wfchange',['id'=>$vo['id'],'status'=>1]); ?>" target=> 禁用</a>
			<?php else: ?>
		 <a class='btn  radius size-S' href="<?php echo url('wfchange',['id'=>$vo['id'],'status'=>0]); ?>" target=> 启用</a>
	   <?php endif; ?>
