<?php /*a:2:{s:64:"C:\Users\Administrator\web\tpflow\app\index\view\news\index.html";i:1582850418;s:62:"C:\Users\Administrator\web\tpflow\app\index\view\pub\base.html";i:1581909452;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
	...
	<table class="table table-border table-bordered table-bg">
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td>
				<!--获取流状态-->
				<?php echo app\index\controller\wf::status($k['status']); ?>
				</td>
				<td class="td-manage">
				<div class="btn-group">
					<span class="btn  radius size-S" data-title="查看" data-href="<?php echo url('view',['id'=>$k['id']]); ?>" onclick="Hui_admin_tab(this)"><i class="Hui-iconfont">查看</span>
						<!--按钮权限验证，审批权限验证，发起验证-->
						<?php echo app\index\controller\wf::btn($k['id'],'news',$k['status']); ?>
