<?php /*a:2:{s:38:"C:\tp6\app\index\view\index\index.html";i:1582794358;s:35:"C:\tp6\app\index\view\pub\base.html";i:1581909452;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		...
		<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
			<ul class="cl">
				<li><?php if(''): ?>
欢迎您：<?php echo htmlentities(''); else: ?>
	请先模拟登入！
<?php endif; ?></li>
...
<aside class="Hui-aside">
		<div class="menu_dropdown bk_2" >
			...
			<dl>
				...
				<?php echo app\index\controller\wf::status(); ?>
...
<script>
var session ='<?php echo htmlentities(''); ?>';
if(session =='' ){
layer.open({
      type: 2,
      title: '网站',
